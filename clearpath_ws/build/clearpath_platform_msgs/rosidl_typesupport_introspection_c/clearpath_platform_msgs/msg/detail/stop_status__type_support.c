...
static rosidl_typesupport_introspection_c__MessageMember clearpath_platform_msgs__msg__StopStatus__rosidl_typesupport_introspection_c__StopStatus_message_member_array[3] = {
  {
    "header",  // name
